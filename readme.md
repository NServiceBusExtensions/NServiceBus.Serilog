...
Log.Logger = new LoggerConfiguration()
    ...
    .CreateLogger();
```
<sup><a href='/src/Sample/Program.cs#L9-L13' title='Snippet source file'>snippet source</a> | <a href='#snippet-configureserilog' title='Start of snippet'>anchor</a></sup>
...
```
<sup><a href='/src/SeqSample/Program.cs#L9-L16' title='Snippet source file'>snippet source</a> | <a href='#snippet-configureserilog-1' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/Sample/Program.cs#L15-L20' title='Snippet source file'>snippet source</a> | <a href='#snippet-useconfig' title='Start of snippet'>anchor</a></sup>
...
serilogTracing.EnableMessageTracing();
```
<sup><a href='/src/SeqSample/Program.cs#L18-L25' title='Snippet source file'>snippet source</a> | <a href='#snippet-useconfig-1' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
Log.CloseAndFlush();
```
<sup><a href='/src/Sample/Program.cs#L30-L33' title='Snippet source file'>snippet source</a> | <a href='#snippet-cleanup' title='Start of snippet'>anchor</a></sup>
<a id='snippet-cleanup-1'></a>
```cs
await endpoint.Stop();
Log.CloseAndFlush();
```
<sup><a href='/src/SeqSample/Program.cs#L41-L44' title='Snippet source file'>snippet source</a> | <a href='#snippet-cleanup-1' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
